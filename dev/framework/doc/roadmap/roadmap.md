...
| Composants industrialisés | ⬜ | 🟡 | ~78 % | prototypes extraits en composants génériques |
| JSON / data métier | ⬜ | 🟡 | ~72 % | édition + relations inter-JSON robustes |
| Tests / robustesse | ⬜ | 🟡 | ~75 % | non-régression et cas négatifs |
...
| 🟡 | ~78 % | 🟦 A / 🟩 B / 🟧 C | extraction et consolidation parallèles de briques framework |
